...
public class TideDebugConsoleViewer extends JPanel implements DefaultFocusComponent,
EBComponent
{

	public TideDebugConsoleViewer()
	{
		...
		if(settingsDirectory != null)
		{
			...
			JLabel label = new JLabel(jEdit.getProperty(
								    "tide-console-viewer.caption",args));
			caption.add(label);
		}

		caption.add(Box.createHorizontalGlue());

		tailIsOn = jEdit.getBooleanProperty("tide-console-viewer.tail", false);
		tail = new JCheckBox(
				     jEdit.getProperty("tide-console-viewer.tail.label"),tailIsOn);
		...
		copy = new JButton(jEdit.getProperty("tide-console-viewer.copy"));
		copy.addActionListener(new ActionHandler());
		caption.add(copy);

		ListModel model = TideDebugLog.getTideDebugLogListModel();
	...
	private class ActionHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				tailIsOn = !tailIsOn;
				jEdit.setBooleanProperty("tide-console-viewer.tail",tailIsOn);
				if(tailIsOn)
				{
					scrollToTail();
				}
