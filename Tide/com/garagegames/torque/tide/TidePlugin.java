...
public class TidePlugin extends EBPlugin
{
   ...
   public void start()
   {
      ...
      */
      // TODO: find our where this REALLY belongs now with the new 4.2. API... :(
   ...
   {
      tideMenu = GUIUtilities.loadMenu(MENU);
      menuItems.addElement(tideMenu);

      // TODO: find our where this REALLY belongs now with the new 4.2. API... :(
      // create our singleton at this point
      tide = Tide.createTide(this);
   }
